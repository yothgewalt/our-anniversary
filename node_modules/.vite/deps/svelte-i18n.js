import {
  derived,
  writable
} from "./chunk-42VLUPNC.js";
import {
  __commonJS,
  __toESM
} from "./chunk-ZIEWFZEU.js";
...
var D = Object.assign(Object.assign({}, L), { set: (e) => {
  if (e && function(e2) {
    if (null == e2)
      return;
    const n = E(e2);
...
var S = (e, n) => {
  const t2 = e.split("&").find((e2) => 0 === e2.indexOf(`${n}=`));
  return t2 ? t2.split("=").pop() : null;
};
var N = (e, n) => {
  const t2 = n.exec(e);
  return t2 && t2[1] || null;
};
var A = (e) => "undefined" == typeof window ? null : N(window.location.hostname, e);
var I = (e) => "undefined" == typeof window ? null : N(window.location.pathname, e);
var F = () => "undefined" == typeof window ? null : window.navigator.language || window.navigator.languages[0];
var z = (e) => "undefined" == typeof window ? null : S(window.location.search.substr(1), e);
var Z = (e) => "undefined" == typeof window ? null : S(window.location.hash.substr(1), e);
var C = (e) => {
...
var J = C((e) => {
  ...
  return t2 && (o = G("number", t2)), new Intl.NumberFormat(n, o);
});
var U = C((e) => {
  var { locale: n, format: t2 } = e, o = v(e, ["locale", "format"]);
  if (null == n)
    throw new Error('[svelte-i18n] A "locale" must be set to format dates');
  return t2 ? o = G("date", t2) : 0 === Object.keys(o).length && (o = G("date", "short")), new Intl.DateTimeFormat(n, o);
});
var V = C((e) => {
  var { locale: n, format: t2 } = e, o = v(e, ["locale", "format"]);
  if (null == n)
    throw new Error('[svelte-i18n] A "locale" must be set to format time values');
  return t2 ? o = G("time", t2) : 0 === Object.keys(o).length && (o = G("time", "short")), new Intl.DateTimeFormat(n, o);
});
var _ = (e = {}) => {
...
var H = C((e, n = P()) => new lib_default(e, n, M().formats, { ignoreTag: M().ignoreTag }));
var K = (e, n = {}) => {
  var t2, o, r2, i2;
  let a2 = n;
  ...
  if (m2) {
    ...
    m2 = null !== (i2 = null !== (r2 = null === (o = (t2 = M()).handleMissingMessage) || void 0 === o ? void 0 : o.call(t2, { locale: u2, id: e, defaultValue: c2 })) && void 0 !== r2 ? r2 : c2) && void 0 !== i2 ? i2 : e;
  if (!s2)
    return m2;
  let f2 = m2;
  try {
    f2 = H(m2, u2).format(s2);
  } catch (n2) {
...
var W = (e, n) => _(n).format(e);
var X = (e, n = P()) => l(e, n);
var Y = derived([D, s], () => K);
var ee = derived([D], () => Q);
var ne = derived([D], () => R);
var te = derived([D], () => W);
var oe = derived([D, s], () => X);
function re(e) {
  return e;
}
function ie(e) {
...
export {
  ...
  m as addMessages,
  ne as date,
  re as defineMessages,
  s as dictionary,
  Y as format,
  q as getDateFormatter,
  Z as getLocaleFromHash,
  A as getLocaleFromHostname,
  F as getLocaleFromNavigator,
  I as getLocaleFromPathname,
  z as getLocaleFromQueryString,
  H as getMessageFormatter,
  _ as getNumberFormatter,
  B as getTimeFormatter,
  $ as init,
  k as isLoading,
  oe as json,
  D as locale,
